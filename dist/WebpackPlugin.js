...
exports.WebpackStoreLoader = void 0;
var path = require('path');
var fs = require('fs');
var requireContext = require('require-context');
var semver = require('semver');
var packageJson = require(path.resolve(process.cwd(), 'package.json'));
var WebpackStoreLoader = /** @class */ (function () {
    function WebpackStoreLoader(usingTypescript, pluginDirectory, storesDirectory, pluginStoresImport) {
    ...
    WebpackStoreLoader.prototype.apply = function (compiler) {
        var _this = this;
    ...
    WebpackStoreLoader.prototype.prepare = function () {
    ...
    WebpackStoreLoader.prototype.cleanFiles = function () {
        var _this = this;
    ...
    WebpackStoreLoader.prototype.processStores = function () {
        this.generatePluginStoreImports();
        this.generateExports();
        this.generateTypeDefs();
        this.generatePlugin();
    };
    WebpackStoreLoader.prototype.generatePluginStoreImports = function () {
        var _this = this;
     ...
     */
    WebpackStoreLoader.prototype.generateExports = function () {
        this.storeExports = '';
     ...
     */
    WebpackStoreLoader.prototype.generateTypeDefs = function () {
     ...
     */
    WebpackStoreLoader.prototype.generatePlugin = function () {
    ...
    WebpackStoreLoader.prototype.getTemplate = function (name) {
        return fs.readFileSync(path.resolve(process.cwd(), 'template', "vue" + this.vueVersion, name + ".template.txt"), { encoding: 'utf-8' });
    };
    /**
     ...
     */
    WebpackStoreLoader.prototype.walkDirectory = function (currentDirPath, isSubDir) {
        var _this = this;
     ...
     * @param pathToPrepare
     */
    WebpackStoreLoader.prototype.preparePath = function (pathToPrepare) {
    ...
    WebpackStoreLoader.prototype.camelize = function (str) {
        return str.replace(/(?:^\w|[A-Z]|\b\w)/g, function (word, index) {
            return index === 0 ? word.toLowerCase() : word.toUpperCase();
        }).replace(/\s+/g, '');
    };
    WebpackStoreLoader.prototype.getVueVersion = function () {
        var _a;
    ...
    return WebpackStoreLoader;
}());
exports.WebpackStoreLoader = WebpackStoreLoader;
